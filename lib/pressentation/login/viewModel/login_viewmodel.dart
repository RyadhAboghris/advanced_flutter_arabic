...
class LoginViewModel extends BaseViewModel
  ...
  StreamController isUserLoggedInSuccessfullySteamController =
  ...
  void dispose() {
    ...
    isUserLoggedInSuccessfullySteamController.close();
  }
  ...
  login() async {
    ...
    (await _loginUseCase.execute(
      ...
      isUserLoggedInSuccessfullySteamController.add(true);
    });
  }
  ...
  Stream<bool> get outIsPasswordValid => _passwordStreamController.stream
      .map((password) => _isUserNameValid(password));
