...
import 'package:advanced_flutter_arabic/pressentation/register/viewmodel/register_viewmodel.dart';
...
class _RegisterViewState extends State<RegisterView> {
  ...
  _bind() {
    ...
    _viewModel.isUserRegisterInSuccessfullySteamController.stream
        .listen((isLoggedIn) {
      if (isLoggedIn) {
...
// all inputs valid button
  ...
  _shopPicker(BuildContext context) {
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(
            ...
            builder: (context, snapshot) {
              return _iamgePicketByUser(snapshot.data);
            },
          )),
  ...
  Widget _iamgePicketByUser(File? image) {
