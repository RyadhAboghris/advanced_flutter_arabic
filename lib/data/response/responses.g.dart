...
ForgotPasswordResponse _$ForgotPasswordResponseFromJson(
    ...
    ForgotPasswordResponse(
      json['support'] == null
          ? null
          : CustomerResponse.fromJson(json['support'] as Map<String, dynamic>),
    )
      ..status = json['status'] as int?
      ..message = json['message'] as String?;
...
HomeRespons _$HomeResponsFromJson(Map<String, dynamic> json) => HomeRespons(
      json['data'] == null
          ? null
...
Map<String, dynamic> _$HomeResponsToJson(HomeRespons instance) =>
    <String, dynamic>{
      'status': instance.status,
      'message': instance.message,
      'data': instance.data,
