...
import '../domain/usecase/store_details_usecase copy.dart';
import '../pressentation/forget_password/forgot_password_viewmodel.dart';
import '../pressentation/login/viewModel/login_viewmodel.dart';
import '../pressentation/main/pages/home/viewmodel/home_viewmodel.dart';
import '../pressentation/register/viewmodel/register_viewmodel.dart';
import 'package:image_picker/image_picker.dart';

import '../pressentation/store_details/viewmodel/store_details_viewmodel.dart';

final instance = GetIt.instance;

Future<void> initAppModule() async {
  // app module , it's a module where we put all generic depedencies

  // shared prefs instance
  final sharedpPrefs = await SharedPreferences.getInstance();

  instance.registerLazySingleton<SharedPreferences>(() => sharedpPrefs);
